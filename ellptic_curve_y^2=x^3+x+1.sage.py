...
_sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_3 = Integer(3); _sage_const_8 = Integer(8); _sage_const_7 = Integer(7); _sage_const_10 = Integer(10); _sage_const_19 = Integer(19); _sage_const_14 = Integer(14)#elliptic curve y^2=x^3+x+1 in normal form
...
alpha = (_sage_const_3 +sqrt(_sage_const_19 )*i)/_sage_const_14 
beta = (_sage_const_3 -sqrt(_sage_const_19 )*i)/_sage_const_14 
def zeta_silverman(q,T):
    return (_sage_const_1 -alpha*T)*(_sage_const_1 -beta*T)/((_sage_const_1 -T)*(_sage_const_1 -q*T))

#computes the Zeta function of y^2=x^3+x+1 over F_7
print(zeta_silverman(_sage_const_7 ,T))
